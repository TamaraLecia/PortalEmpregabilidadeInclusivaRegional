...
<head>
  ...
  <link rel="icon" type="image/png" href="imagen/acessibilidade.png">
...
<body>
  <aside>
    ...
    <ul>
      ...
      <li><a href="VagasOfertadas.html">Minhas Vagas</a></li>
      <li><a href="#">Sair</a></li>
    </ul>
  </aside>
  ...
  <main>
    ...
    <section class="content">
      ...
      <form id="formAtualizar" action="atualizarEmpresa">
        <div class="form-group">
        <input type="text" id="chavePrimaria" name="chavePrimaria" value="<%=empresa.getId()%>">
          <label for="nome-empresa">Nome da Empresa:</label>
          <input type="text" id="nomeEmpresa" name="nomeEmpresa" value="<%=empresa.getNomeEmpresa() %>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="setor" name="setor" value="<%=empresa.getSetor() %>">
        </div>

        <div class="form-group">
          <label for="site">Site Oficial:</label>
          <input type="text" id="site" name="site" value="<%=empresa.getSite() %>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="regioes" name="regioes" value="<%=empresa.getRegiaoAtuacao() %>">
        </div>

        <div class="form-group">
          <label for="programa-inclusao">Possui Programas de Inclusão?</label>
          <input type="text" id="inclusao" name="inclusao" value="<%=empresa.getProgramaInclusao() %>">
        </div>
        ...
        <button  onclick="salvar()" class="btn">Salvar alterações</button>
        <button  href="PerfilEmpresa.jsp" class="btn">Cancelar</button>
        </div>
