...
<div vw class="enabled">
  ...
  <main>
    ...
    <div class="content">
      ...
      <p><strong>Titulo:</strong> <%=vaga.getTitulo()%></p>
      <p><strong>Descrição:</strong> <%=vaga.getDescricao()%></p>
      <p><strong>Requisitos:</strong> <%=vaga.getRequisito() %></p>
      <p><strong>Salario:</strong> <%=vaga.getSalario() %></p>
      <p><strong>Localização: </strong><%=vaga.getLocalizacao() %></p>
      <p><strong>Acessibilidade:</strong> <%=vaga.getAcessibilidade() %></p>
      <p><strong>Data de Expiração:</strong> <%=vaga.getDataExpiracao() %></p>
      <%}%>
      <%} %><%else{%>
