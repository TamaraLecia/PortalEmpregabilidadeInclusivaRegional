...
@WebServlet(urlPatterns = { "/ControllerLogin", "/login","/verPerfil", "/select", "/update", "/logout", "/sair", "/logout2"})
public class ControllerLogin extends HttpServlet {
	...
	protected void realizarLogin(HttpServletRequest request, HttpServletResponse response)
		...
		int nivelAcesso = dao.pegarNivelAcesso(email, senha);
		...
		//PessoaPCDDAO dao = new PessoaPCDDAO();
		boolean loginSucesso = dao.autenticar(email, senha);
