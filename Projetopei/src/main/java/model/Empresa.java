...
public class Empresa {
	...
	public Empresa(int id, int administrador_id, String nomeEmpresa, String cnpj, String setor, String site,String endereco, String regiaoAtuacao, String programaInclusao, String tipoVaga) {
		this.id = id;
