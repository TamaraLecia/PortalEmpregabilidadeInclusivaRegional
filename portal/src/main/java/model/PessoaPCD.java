...
public class PessoaPCD extends Pessoa {
	...
	public PessoaPCD(int id, String nome, String telefone, String email, String senha) {
	...
	public PessoaPCD(int id, String nomeString, String telefone, String email, String senha, String dataNascimento,String genero, String endereco, String nacionalidade, String cpf, String deficiencia,String formacaoAcademica, String areaInteresse, String descricaoDeficiencia) {
